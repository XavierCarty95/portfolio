        ...
        return ( 
            <div className="container">
                <div className="welcome"> 
                    ...
                    <p> Hello, my name is Xavier, though some call me X. I am a software engineer with over 5 years of experience, currently working at The Knot Worldwide as an iOS developer.
                    <br></br>
                    <br></br>
