...
function About() { 
    return ( 
        <div className="about"> 
            ...
            <p className="profile-description">I am a passionate software engineer with five years of experience specializing in iOS app development using both SwiftUI and UIKit. My journey in technology is complemented by a rich background in psychology, which enhances my approach to building user-centric mobile and web applications.
                                                <br></br>
                                                <br></br>
